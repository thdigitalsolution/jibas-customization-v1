	...
	<tr>
        ...
        <td align="center" width="120">
            <a href="http://www.jibas.net/content/sptfgr/sptfgr.php" target="_blank">
                <img id="btSptFgr" src="images/btnmenu_green_p_33.png" onMouseOver="changeImage('btSptFgr','images/btnmenu_green_a_33.png')" onMouseOut="changeImage('btSptFgr','images/btnmenu_green_p_33.png')" border="0"
                     class="vtip" title="Pendataan presensi siswa dan pegawai menggunakan sidik jari">
            </a>
        </td>
        <td align="center" width="120">
            <a href="http://www.jibas.net/content/sptface/sptface.php" target="_blank">
                <img id="btSptFace" src="images/btnmenu_green_p_34.png" onMouseOver="changeImage('btSptFace','images/btnmenu_green_a_34.png')" onMouseOut="changeImage('btSptFace','images/btnmenu_green_p_34.png')" border="0"
                     class="vtip" title="Pendataan presensi siswa dan pegawai menggunakan identifikasi wajah">
            </a>
        </td>
	</tr>
	</table>
