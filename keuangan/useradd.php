...
if (isset($_REQUEST['simpan'])) {
	...
	if ($num_c == 0) {
		if ($tingkat == 1) {
			...
			$sql_hakakses = "INSERT INTO jbsuser.hakakses SET login='$_REQUEST[nip]', departemen='$_REQUEST[departemen]', tingkat=1, modul='KEUANGAN', keterangan='" . CQ($_REQUEST['keterangan']) . "'";
